...
class HxValueNoise
{
	 ...
	 * @return 	A string that is usuable for FlxTilemap.loadMap()
	 */
	public static function generateFloatMatrix(Columns:Int, Rows:Int, NumOctaves:Int = 1, Persistance:Float = 0.5):Array<Array<Float>>
	{
	 ...
	 */
	public static function generateIntMatrix(Columns:Int, Rows:Int, NumOctaves:Int = 1, Persistance:Float = 0.5, NumLevels:Int = 2):Array<Array<Int>>
	{
		var matrix:Array<Array<Int>> = InitIntMatrix(Columns, Rows);
		var map:Array<Array<Float>> = generateFloatMatrix(Columns, Rows, NumOctaves, Persistance);
		NumLevels--;
	 ...
	 */
	public static inline function generateMatrixString(Columns:Int, Rows:Int, NumOctaves:Int = 1, Persistance:Float = 0.5, NumLevels:Int = 2):String
	{
		return convertMatrixToString(generateIntMatrix(Columns, Rows, NumOctaves, Persistance, NumLevels));
	}
